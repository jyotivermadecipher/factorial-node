...
var AppComponent = /** @class */ (function () {
    function AppComponent(fb, factorialService) {
        this.fb = fb;
    ...
    AppComponent.prototype.calculateFactorial = function () {
        var _this = this;
        console.log(this.factorialForm);
        if (this.factorialForm.valid) {
            var data = this.factorialForm.controls.number.value;
            this.factorialService.calculatefactorial(data).subscribe(function (res) {
                _this.factorial = res.factorial;
                _this.showFactorial = true;
            });
        }
        else {
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _app_service__WEBPACK_IMPORTED_MODULE_3__["FactorialService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/*!********************************!*\
  !*** ./src/app/app.service.ts ***!
  \********************************/
/*! exports provided: FactorialService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FactorialService", function() { return FactorialService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var FactorialService = /** @class */ (function () {
    function FactorialService(http) {
        this.http = http;
    }
    FactorialService.prototype.calculatefactorial = function (data) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + 'getFactorial?number=' + data);
    };
    FactorialService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = __webpack_require__(/*! /home/dz-gg-07/DZ/TestTask/factorial-ng/src/main.ts */"./src/main.ts");
